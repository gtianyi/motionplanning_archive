...
set ylabel "Solution Cost"
   plot './outfile/data-abeast' u 1:2 w lp ls 1 t 'abeast' axes x1y1, \
   './outfile/data-abeastcost' u 1:2 w lp ls 2 t 'abeast-onlyPruning' axes x1y1, './outfile/data-sst' u 1:2 w lp ls 3 t 'sststar' axes x1y1
set output
