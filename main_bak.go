...
func Anytime() {
	filters := map[string]map[string]string{
		...
		"BEAST": map[string]string{"planner": "BEAST",
			"numprmedges": "5", "prmsize": "1000", "stateradius": "6"},
		...
		"A-BEAST (SST*)": map[string]string{"planner": "AnytimeBEAST_4",
			"sstpruning":  "SSTStar",
			"costpruning": "G",
			"sampler":     "BEAST",
		},
		"A-BEAST only Prunning (SST*)": map[string]string{"planner": "AnytimeBEASTCost_4",
			"sstpruning":  "SSTStar",
			"costpruning": "G",
			"sampler":     "BEAST",
		},
